...
Create the following RSpec tests. For generating test data use [FactoryGirl](https://github.com/thoughtbot/factory_girl), [FactoryGirl rails gem](https://github.com/thoughtbot/factory_girl_rails):
...
Deploy your Rails app to [Heroku](https://www.heroku.com/).
